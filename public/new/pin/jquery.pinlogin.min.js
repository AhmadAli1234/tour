...
!(function (o, t, e, i) {
    "use strict";
    var n = "pinlogin",
        s = { fields: 5, placeholder: "•", autofocus: !0, reset: !0, complete: function (t) {}, invalid: function (t, e) {}, keydown: function (t, e, i) {}, input: function (t, e, i) {} };
    function a(t, e) {
        (this.element = t), (this.settings = o.extend({}, s, e)), (this._defaults = s), (this._name = n), this.init();
    }
    o.extend(a.prototype, {
        init: function () {
            (this._values = new Array(this.settings.fields)), (this._container = o("<div />").prop({ id: this._name, class: this._name }));
        ...
        _createInput: function (t, e) {
            return o("<input>").prop({ type: "text", id: t, name: t, maxlength: 1, inputmode: "text", autocomplete: "off", class: "pinlogin-field", "placeholder": "_" });
        },
            ...
            t.on(
                ...
                t.on(
                    ...
                    o.proxy(function (t) {
                        ...
                        if ((o(this).removeClass("invalid"), s.settings.input(t, o(this), n), (s._values[n] = o(this).val()), s.settings.hideinput && o(this).val(s.settings.placeholder), n < s.settings.fields - 1))
                            s._getField(n + 1).removeProp("readonly"), s.focus(n + 1);
                        else {
